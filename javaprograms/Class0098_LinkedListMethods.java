...
public class Class0098_LinkedListMethods {
	...
	public static void main(String[] args) {
		...
		a1.clear();
		System.out.println("After clearing LinkedList a1 will be --> " + a1);
		a1.add("mobiles");
		a1.add("books");
		a1.add("watches");
		a1.add("printers");
		System.out.println("LinkedList a1 after adding mobiles and books --> " + a1);
		LinkedList b1 = new LinkedList();
		b1.add("clothes");
		b1.add("camera");
		System.out.println("LinkedList b1 is --> " + b1);
		a1.addAll(b1);
