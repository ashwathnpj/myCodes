...
public class SeClass0053_PopUp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement ef = driver.findElement(By.id("file"));
		ef.sendKeys("C:\\Users\\ashwathnpj\\javaprograms\\selenium\\src\\Screenshots\\ScreenshotGoogle.png");
		...
		// driver.switchTo().alert().dismiss(); //if there are two options
